export function SystemStatusLoadingState() {
  return (
    <div
...
interface SystemStatusErrorStateProps {
  message: string;
  onRetry: () => void;
}

export function SystemStatusErrorState({ message, onRetry }: SystemStatusErrorStateProps) {
  return (
    <div
