export function SupplierFolderLoadingState() {
  return (
    <div
...
interface SupplierFolderErrorStateProps {
  message: string;
  onRetry: () => void;
}

export function SupplierFolderErrorState({ message, onRetry }: SupplierFolderErrorStateProps) {
  return (
    <div
